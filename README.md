...
- **Widget guides** *(released in 0.2.9)* — per-widget usage docs in the wiki, available at `wiki/welcome.md` and `https://github.com/elenanight/windfall/wiki/welcome.md`.
